...
typedef union{
	struct {
			...
			/* 0x21 */	
			__IO  uint8_t  PAD_8_INPUT_PULL_UP:1;      //  0    8
			__IO  uint8_t  PAD_9_INPUT_PULL_UP:1;      //  0    9  P_10
			...
			__IO  uint8_t  PAD_21_INPUT_PULL_UP:1;   //usart  0           
			__IO  uint8_t  PAD_22_INPUT_PULL_UP:1;   //usart  0  9F
			...
			__IO  uint8_t  PAD_28_INPUT_PULL_UP:1;   // SW
			__IO  uint8_t  PAD_29_INPUT_PULL_UP:1;   // SW   CF  
