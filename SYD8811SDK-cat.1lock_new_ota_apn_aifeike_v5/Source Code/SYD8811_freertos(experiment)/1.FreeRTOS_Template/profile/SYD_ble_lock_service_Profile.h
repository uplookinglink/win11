...
/* UART*/
#define BLE_UART 0xCCD0
#define BLE_UART_Write_UUID 0xCCD2
#define BLE_UART_Write_VALUE_HANDLE 0x001D
#define BLE_UART_NOTIFY_UUID 0xCCD1
...
{
   0x03,
   0xD0, 0xCC, 0xD1, 0xCC, 0x1F, 0x00, 0x20, 0x00, 0x00, 0x00, 
...
static const uint8_t _gatt_database_primary[] =
{
   ...
   0x09, 0x1B, 0x00, 0x00, 0x28, 0x20, 0x00, 0xD0, 0xCC, //     0x001B  <Primary Service(0x2800)>  <UART(0xCCD0)>
...
static const uint8_t _gatt_database_characteristic[] =
{
   ...
   0x0A, 0x1C, 0x00, 0x03, 0x28, 0x08, 0x1D, 0x00, 0xD2, 0xCC, //     0x001C  <Characteristic(0x2803)>  <Properties:0x08>  <Value Handle:0x001D>  <UUID:UART Write(0xCCD2)>
   0x0A, 0x1E, 0x00, 0x03, 0x28, 0x12, 0x1F, 0x00, 0xD1, 0xCC, //     0x001E  <Characteristic(0x2803)>  <Properties:0x12>  <Value Handle:0x001F>  <UUID:UART NOTIFY(0xCCD1)>
...
static const uint8_t _gatt_database_value[] =
{
   ...
   0x1C, 0x00, 0x1D, 0x00, 0x10, 0xD2, 0xCC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //     0x001D    <UUID:UART Write(0xCCD2)>  <Value:Vender Define Value(0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00)>
   0x1C, 0x00, 0x1F, 0x00, 0x10, 0xD1, 0xCC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //     0x001F    <UUID:UART NOTIFY(0xCCD1)>  <Value:Vender Define Value(0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00)>
