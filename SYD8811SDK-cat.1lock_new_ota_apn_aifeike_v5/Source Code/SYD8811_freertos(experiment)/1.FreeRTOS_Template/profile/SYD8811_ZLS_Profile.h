...
/* UART*/
#define BLE_UART 0x000A
#define BLE_UART_Write_UUID 0x000C
#define BLE_UART_Write_VALUE_HANDLE 0x001D
#define BLE_UART_NOTIFY_UUID 0x000B
...
{
   0x01,
   0x0A, 0x00, 0x0B, 0x00, 0x1F, 0x00, 0x20, 0x00, 0x00, 0x00, 
};
...
static const uint8_t _gatt_database_primary[] =
{
   ...
   0x17, 0x1B, 0x00, 0x00, 0x28, 0x20, 0x00, 0x9E, 0xCA, 0xDC, 0x24, 0x0E, 0xE5, 0xA9, 0xE0, 0x93, 0xF3, 0xA3, 0xB5, 0x0A, 0x00, 0x40, 0x6E, //     0x001B  <Primary Service(0x2800)>  <UART(0x6E40000AB5A3F393E0A9E50E24DCCA9E)>
   0x09, 0x21, 0x00, 0x00, 0x28, 0xFF, 0xFF, 0x00, 0xFF, //     0x0021  <Primary Service(0x2800)>  <OTA(0xFF00)>
};
...
static const uint8_t _gatt_database_characteristic[] =
{
   ...
   0x18, 0x1C, 0x00, 0x03, 0x28, 0x08, 0x1D, 0x00, 0x9E, 0xCA, 0xDC, 0x24, 0x0E, 0xE5, 0xA9, 0xE0, 0x93, 0xF3, 0xA3, 0xB5, 0x0C, 0x00, 0x40, 0x6E, //     0x001C  <Characteristic(0x2803)>  <Properties:0x08>  <Value Handle:0x001D>  <UUID:UART Write(0x6E40000CB5A3F393E0A9E50E24DCCA9E)>
   0x18, 0x1E, 0x00, 0x03, 0x28, 0x10, 0x1F, 0x00, 0x9E, 0xCA, 0xDC, 0x24, 0x0E, 0xE5, 0xA9, 0xE0, 0x93, 0xF3, 0xA3, 0xB5, 0x0B, 0x00, 0x40, 0x6E, //     0x001E  <Characteristic(0x2803)>  <Properties:0x10>  <Value Handle:0x001F>  <UUID:UART NOTIFY(0x6E40000BB5A3F393E0A9E50E24DCCA9E)>
...
static const uint8_t _gatt_database_value[] =
{
   ...
   0x2A, 0x00, 0x1D, 0x00, 0x90, 0x9E, 0xCA, 0xDC, 0x24, 0x0E, 0xE5, 0xA9, 0xE0, 0x93, 0xF3, 0xA3, 0xB5, 0x0C, 0x00, 0x40, 0x6E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //     0x001D    <UUID:UART Write(0x6E40000CB5A3F393E0A9E50E24DCCA9E)>  <Value:Vender Define Value(0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00)>
   0x2A, 0x00, 0x1F, 0x00, 0x90, 0x9E, 0xCA, 0xDC, 0x24, 0x0E, 0xE5, 0xA9, 0xE0, 0x93, 0xF3, 0xA3, 0xB5, 0x0B, 0x00, 0x40, 0x6E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //     0x001F    <UUID:UART NOTIFY(0x6E40000BB5A3F393E0A9E50E24DCCA9E)>  <Value:Vender Define Value(0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00)>
