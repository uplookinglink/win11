...
#define BLE_SERVICE_UUID_OTA_READ_WRITE BLE_OTA_Read_Write_UUID
/* BATTERY_SERVICE*/
...
{
   0x03,
   0xD2, 0xCC, 0xD1, 0xCC, 0x1F, 0x00, 0x20, 0x00, 0x00, 0x00, 
...
static const uint8_t _gatt_database_primary[] =
{
   ...
   0x09, 0x1B, 0x00, 0x00, 0x28, 0x20, 0x00, 0xD0, 0xCC, //     0x001B  <Primary Service(0x2800)>  <UART(0x0001)>
...
static const uint8_t _gatt_database_characteristic[] =
{
   ...
   0x0A, 0x1C, 0x00, 0x03, 0x28, 0x08, 0x1D, 0x00, 0xD2, 0xCC, //     0x001C  <Characteristic(0x2803)>  <Properties:0x08>  <Value Handle:0x001D>  <UUID:UART Write(0x0002)>
   0x0A, 0x1E, 0x00, 0x03, 0x28, 0x12, 0x1F, 0x00, 0xD1, 0xCC, //     0x001E  <Characteristic(0x2803)>  <Properties:0x10>  <Value Handle:0x001F>  <UUID:UART NOTIFY(0x0003)>
   0x0A, 0x22, 0x00, 0x03, 0x28, 0x0E, 0x23, 0x00, 0x01, 0xFF, //     0x0022  <Characteristic(0x2803)>  <Properties:0x0A>  <Value Handle:0x0023>  <UUID:OTA Read Write(0xFF01)>
