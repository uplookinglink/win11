	...
	if((ota_section_size==0) || (ota_state==0))
	{
		...
		{	
			case CMD_FW_ERASE:
				...
				Timer_Evt_Start(OTA_MANAGE_TIMER_EVT_ID);
				ota_state=1;
			...
			case CMD_4KSETTING_WRITE:
				...
				#if defined(_DEBUG_) || defined(_SYD_RTT_DEBUG_)
					dbg_printf("CMD_4KSETTING_WRITE \r\n");
				#endif
				ota_state=5;
				break;
			case CMD_4KSETTING_UPGRADE:
				...
				#if defined(_DEBUG_) || defined(_SYD_RTT_DEBUG_)
					dbg_printf("CMD_4KSETTING_UPGRADE \r\n");
				#endif
				ota_state=6;
				break;
			...
			case CMD_FLASHDATA_UPGRADEV30:
				...
				#if defined(_DEBUG_) || defined(_SYD_RTT_DEBUG_)
					dbg_printf("CMD_FLASHDATA_UPGRADEV30 \r\n");
				#endif			
				ota_state=3;
				break;
		}
