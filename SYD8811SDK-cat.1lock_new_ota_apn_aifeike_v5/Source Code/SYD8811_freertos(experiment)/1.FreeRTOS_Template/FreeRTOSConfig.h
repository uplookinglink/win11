...
#define FREERTOS_USE_TIMER1    1 /**< Use timer for system */
...
#define configTICK_SOURCE FREERTOS_USE_TIMER1
...
#define configUSE_TICKLESS_IDLE 						1//置1：空闲时会执行睡眠任务
...
#define configMINIMAL_STACK_SIZE                        ( 260 ) //128  512  240
#define configTOTAL_HEAP_SIZE                           ( 1024*8 )
#define configMAX_TASK_NAME_LEN                         ( 10 ) //5
...
#define configTIMER_TASK_STACK_DEPTH            								 ( 240 ) //240
...
#elif (configTICK_SOURCE == FREERTOS_USE_TIMER1)
